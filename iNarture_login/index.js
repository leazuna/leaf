...
var a = document.getElementById("inBtn");
...
//     document.getElementById("bu").innerHTML = "Hello World";
// });
//
...
//       addMarker(longitude, latitude); //Creates marker in map using lon & lat
//       storeCoord(longitude, latitude, "My position test"); //Stores corodinates in DB (table 'coord')
